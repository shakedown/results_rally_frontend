...
function loadEvent()
{	
	var url = path + '6/event.json?callback=?';  //added direct link to event files so it  no longer uses live results but displays static info troughout the whole year
